...
Json tokens are used in modern web services, tokens are a strings of cryptic text that are stored on the client-side using local storage. The tokens are issued by the servers.

- [ ] What steps can you take in your web apps to keep your data secure?

Encrypt login page, use tokens, keep software up to date, back up data, hire a security expert.

- [ ] Describe how web servers work.

The web servers process the data that was requested by client over the http protocols. The received data from the server can be stored, processed and delivered as web pages.
